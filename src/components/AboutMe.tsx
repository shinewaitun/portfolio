...
export default function AboutMe() {
  return (
    <div className="relative min-w-screen flex flex-col md:flex-row items-start justify-center pt-20 overflow-hidden">
      <div className="container flex flex-col gap-8 justify-center items-center text-start mx-auto px-4 py-8 relative z-10">
        ...
        <div className="flex bubble-text rounded-2xl justify-start items-center gap-5 py-2 px-4">
          <DatabaseZap size={50} />
          <p className="text-3xl">Database Administration</p>
        </div>
      </div>
      <div className="container mx-auto px-4 py-8 relative z-10">
        <h2 className="text-3xl font-bold text-start mb-10 text-white">
          About me
        </h2>
        <p className="text-lg font-bold text-start mb-10 text-white">
